  ...
  return (
    <CustomField
      ...
      labelProps={{
        ...
        className: disabled ? undefined : "cursor-ew-resize touch-none",
    ...
    >
      <div className="flex items-center gap-3">
        ...
        <div
          className={cx(
            "flex h-8 items-center rounded-sm border bg-paper transition-colors focus-within:border-select",
        ...
        >
          <input
            ...
            onBlur={onBlur}
            onKeyDown={onKeyDown}
            className="h-full min-w-0 flex-1 bg-transparent px-2 font-mono text-sm text-ink outline-none"
          />
          {unit && <span className="pr-2 font-mono text-xs text-muted">{unit}</span>}
        </div>
      </div>
    </CustomField>
  );
