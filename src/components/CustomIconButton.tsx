...
export function CustomIconButton({
  ...
  return (
    <button
      ...
      className={cx(
        "relative inline-flex shrink-0 items-center justify-center rounded-sm border transition-colors",
    ...
    >
      ...
      {hint && (
        <span
          aria-hidden
          className="absolute right-0.5 bottom-0 font-mono text-[9px] leading-none text-muted"
        >
          {hint}
        </span>
      )}
